          ...
          <div className="flex justify-center mb-6">
            <div className="w-20 h-20 rounded-full bg-red/10 flex items-center justify-center">
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M30 10L10 30M10 10L30 30" stroke="#F23030" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
          </div>

          <h1 className="font-bold text-2xl text-dark mb-3">Error en el Pago</h1>
